...
export class TaskViewPage {
  ...
  constructor(public navCtrl: NavController,
    ...
    console.log("Is the current user the owner? " + this.userIsTaskOwner + " ownderID = " + this.selectedTask.ownerUserId + " and currId = " + this.curUserToken.uid);
    ...
    //if (this.userIsTaskOwner) {
      ...
      this.db.collection("users").doc(this.curUserToken.uid).get().then(doc=> {
        ...
        console.log("wantedSkills are "+ this.selectedTask.wantedSkills);

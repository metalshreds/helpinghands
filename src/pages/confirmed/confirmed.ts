...
export class ConfirmedPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams) {
    ...
    this.tasks.push(new TaskObjectProvider('Sequencing Ducks', 6,
      '12:00 pm, April 30th','We are looking for someone to help with a ' +
      ...
      'lab and know how to sequence DNA.', req1, false,
      'UW Duck Research Team'));
    this.tasks.push(new TaskObjectProvider('The Art of Welding', 4,
      '9:30 am, May 2nd', 'I need someone to teach me basic welding so that ' +
      'I may use it in an art piece I am working on.', 'Must be able to ' +
      'teach basic welding techniques.', req2, false, 'Georgia O Keefe'));
    this.tasks.push(new TaskObjectProvider('How Did This Happen?', 2,
      '7:30 am, May 3rd','I went outside last night and saw that my bike' +
      ...
      ' chain.', req2, false,'Johnson'));
    this.tasks.push(new TaskObjectProvider('Welders Down', 5.5,
      '6:30 pm, May 3rd','Our welders are all sick, and we need someone to' +
      ' fill in for them. It will be few quick frame welds that we need.',
      'Must be able to cleanly weld', req2, false, 'UW SAE Hybrid Team'));
  }
